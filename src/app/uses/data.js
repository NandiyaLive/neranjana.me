export const hardware = [
  {
    name: "Laptop",
    description: "Lenovo ThinkPad T480 (i5, 24GB RAM, 500GB SSD)",
  },
  {
    name: "Monitor",
...
export const devSoft = [
  ...
  {
    name: "API Testing",
    description: "Insomnia (Poastman is good too)",
...
export const otherSoft = [
  ...
  {
    name: "2FA",
    description: "Twilio Authy",
    url: "https://authy.com",
  },
  {
    name: "Main Browser",
    description: "Mozilla Firefox",
    url: "https://mozilla.org/en-US/firefox",
  },
  {
