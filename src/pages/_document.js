...
export default function Document() {
  return (
    <Html lang="en">
      ...
      <body className="bg-bgColor-light text-stone-900 dark:bg-bgColor-dark dark:text-gray-50 max-h-screen h-screen overflow-hidden xmd:overflow-y-auto transition-colors duration-200">
        <Main />
        <NextScript />
      </body>
    </Html>
