        ...
        <div className="container">
          <div className="project-cards grid grid-3">
            <div className="card">
              ...
              <p className="pt-10 text-400 details">A bot that can help you to download media from Instagram over Telegram.</p>
              <p className="ref">
            ...
            <div className="card">
              ...
              <p className="pt-10 text-400 details">A script that automates downloading stories and uploading to Telegram.</p>
              <p className="ref">
            ...
            <div className="card">
              ...
              <p className="pt-10 text-400 details">API to fetch news from AdaDerana, a major news network in Sri Lanka.</p>
              <p className="ref">
            ...
            <div className="card">
              <p className="is-text-18 text-600">Portfolio Website</p>
              <p className="pt-10 text-400 details">This is the v5 of my portfolio website. Check all the versions below.</p>
              <p className="ref text-500">
                <a href="https://github.com/NandiyaLive/neranjana.tk" title="View on GitHub" target="_blank" rel="noreferrer">
                  Current Version
                </a>
                {" | "}
                <a href="https://github.com/NandiyaLive/archived.neranjana.tk" title="View on GitHub" target="_blank" rel="noreferrer">
                  Old Versions
                </a>
              </p>
            </div>
          ...
          <div className="other pt-10">
            <p className="is-text-20 text-500 py-10">Other Noteworthy Projects</p>
            <ul className="text-500 mx-10">
              <li>
                <span>
